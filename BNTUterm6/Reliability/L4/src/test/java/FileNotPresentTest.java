...
import java.net.URL;
public class FileNotPresentTest {
  ...
  @Test
  public void fileNotPresent() throws InterruptedException {
    ...
    driver.findElement(By.cssSelector(".mat-list-item:nth-child(5) .icon")).click();
    {
