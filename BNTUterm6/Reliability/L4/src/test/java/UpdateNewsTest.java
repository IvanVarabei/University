...
public class UpdateNewsTest {
  ...
  public void updateNews() throws InterruptedException {
    ...
    driver.findElement(By.cssSelector("body > app-root > div > div > app-subject-news > div > div.subject-news-component__list > div > div.subject-news-component__news-header > div > button:nth-child(1)")).click();
    driver.findElement(By.id("mat-input-0")).click();
    driver.findElement(By.id("mat-input-0")).sendKeys("newName");
    ...
    {
      Thread.sleep(3000);
      assertThat(driver.findElement(By.cssSelector(".subject-news-component__news-title")).getText(), is("Testnewname"));
    }
  }
}
