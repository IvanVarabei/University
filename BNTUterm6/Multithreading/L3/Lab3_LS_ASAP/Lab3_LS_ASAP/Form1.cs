...
namespace Lab3_LS_ASAP
{
    public partial class Form1 : Form
    {
        ...
        private void ViewResults()
        {
            ...
            {
                dataGridView1.Rows[0].Cells[i + 1].Style.BackColor = Color.FromArgb(168, 196, 26);
            ...
            {
                dataGridView1.Rows[i + 1].Cells[0].Style.BackColor = Color.FromArgb(168, 196, 26);
            ...
            for (int i = 0; i < LSA.countTypes; i++)
            {
                ...
                {
                    dataGridView1.Rows[LSA.arrayTypes[i][k]].Cells[i + 1].Style.BackColor = Color.FromArgb(214, 63, 13);
                }
            }
            ...
            {
                // по вертикали
                dataGridView2.Rows[i].Cells[0].Style.BackColor = Color.FromArgb(168, 196, 26);
                ...
                dataGridView2.Rows[0].Cells[i].Style.BackColor = Color.FromArgb(168, 196, 26);
            ...
            for (int i = 0; i < LSA.countOperations; i++)
            {
                for (int k = 0; k < LSA.arrayH[i].Length; k++)
                {
                    if (LSA.arrayH[i][k] == 1)
                    {
                        dataGridView2.Rows[i + 1].Cells[k + 1].Style.BackColor = Color.FromArgb(214, 63, 13);
                    }
                }
            }
        }
