...
public class Simplex2 {
    ...
    public static void main(String... adf) {
        ...
        Simplex2 simplex = new Simplex2(3, 6);
        simplex.fillTable(data);
        System.out.println("Initial table");
        simplex.print();
        while (true) {
            Simplex2.ERROR error = simplex.compute();
            if (error == Simplex2.ERROR.IS_OPTIMAL || error ==  ERROR.UNBOUNDED) {
                break;
            }
            simplex.print();
        }
    ...
    public Simplex2(int numOfConstraints, int numOfUnknowns){
