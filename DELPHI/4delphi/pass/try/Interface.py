...
class InputBox:
    ...
    def draw(self, screen,a,b,key):
        ...
        screen.blit(text6, (5, 170))
        if  gcd(int(key),26)==1:
            f7= pg.font.SysFont(None, 35)
            text7 = f7.render("(key is right)", 0, (0, 180, 0))
            screen.blit(text7, (470, 170))
        else:
            f8= pg.font.SysFont(None, 35)
            text8 = f8.render("key is wrong", 0, (0, 180, 0))
            screen.blit(text8, (470, 170))
            
            
       
def main():
    clock = pg.time.Clock()
    input_box1 = InputBox(260, 230, 290, 26)
    input_box2 = InputBox(260, 350, 290, 26)
    input_box3 = InputBox(260, 170, 290, 26)
