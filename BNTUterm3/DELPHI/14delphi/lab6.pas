...
begin
  ...
  edt2.Text := '11';
  edt3.Text := '2019';
  cbb1.Items.Add('Василевский Д.М.');
  cbb1.Items.Add('Карачинский А.А.');
  cbb1.Items.Add('Смоляков И.И.');
  cbb2.Items.Add('1');
  cbb2.Items.Add('2');
  cbb2.Items.Add('3');
  cbb3.Items.Add('Сотрудник');
  cbb3.Items.Add('Глава отдела');
  cbb3.Items.Add('Секретарь');
  mmo1.Clear;
  mmo2.Clear;
  Nzap := 0;
  btn1.Hide;
