...
clauses
    семья(чл_с("Иван","Иванов",дат(1,"май",1940),раб("инженер",140)),
    ...
    семья (чл_с("Лев","Сидорик",дат(12,"февраль",1929),раб("хирург",300)),
 ...
 семья (чл_с("","",дат(0,"",0),раб("",0)),
    ...
    запрос_10:-
        семья(чл_с(_,Ф,_,_),_,_),
        количество_детей_семьи(Ф, Кол_дет),
        Кол_дет = 0,
        write(Ф),nl,fail.
    ...
    запрос_11:-
        семья(чл_с(Имя_М,Фамилия_М,_,раб(_,Оклад_М)),чл_с(_,_,_,раб(_,Оклад_Ж)),_),
        Оклад_М = 0,
        Оклад_Ж > 0,
        write(Имя_М, " ", Фамилия_М),nl,fail.
    ...
    запрос_12:-
        семья(чл_с(_,_,дат(_,_,Год_М),_),чл_с(_,_,дат(_,_,Год_Ж),_),Дети),Год_М<>0,Год_Ж<>0,
        Разница = abs(Год_М - Год_Ж),
        Разница >= 15,
        write(Дети),nl,fail.
