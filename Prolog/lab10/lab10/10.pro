...
clauses
    ...
    process(1):-
        ...
        file_str(Name,S), %cчитывние информации из НЭЙМ в С в виде строки
        
        write("Файл создан, данные записаны. Нажмите любую клавишу\n"),
    ...
    process(2):-
        ...
        existfile(Name), %проверка существования файла
        
        file_str(Name,TempStr), %считывание из НЭЙМ в СТРОКУ ТЕМПстр
        ...
        file_str(Name,SfileWrite), %считывание из НЭЙМ в СТРОКУ ТЕМПстр
    ...
    process(3):-
        ...
        file_str(Name,S), %считываем
        
        write(S),nl,
        
        
        openread(datafile,Name), % открытьь для чтения
        
        readdevice(datafile),
        
        
        convert_file(L),%строка
        ...
        openwrite(datafile,Name),%открытіе для чтенія
        
        edit_file(L,L1),%изменить строку считанную выще на введенную с клавиатуры
