========================================================================
       MICROSOFT FOUNDATION CLASS LIBRARY : mycalc3
========================================================================


AppWizard has created this mycalc3 application for you.  This application
not only demonstrates the basics of using the Microsoft Foundation classes
but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your mycalc3 application.

mycalc3.h
    This is the main header file for the application.  It includes other
    project specific headers (including Resource.h) and declares the
    CMycalc3App application class.
...
res\mycalc3.ico
    ...
    icon is included by the main resource file mycalc3.rc.
...
mycalc3Dlg.h, mycalc3Dlg.cpp - the dialog
    These files contain your CMycalc3Dlg class.  This class defines
    the behavior of your application's main dialog.  The dialog's
    template is in mycalc3.rc, which can be edited in Microsoft
	Developer Studio.

DlgProxy.h, DlgProxy.cpp - the automation object
    These files contain your CMycalc3DlgAutoProxy class.  This class
...
StdAfx.h, StdAfx.cpp
    ...
    named mycalc3.pch and a precompiled types file named StdAfx.obj.
